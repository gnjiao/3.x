...
namespace Hdc.Mv.PropertyItem.Controls
{
    ...
    /// </summary>
    public partial class RoiControlEditor : UserControl, ITypeEditor
    {
        public RoiControlEditor()
        {
            InitializeComponent();            

            RadioButtonRect1.AddHandler(RadioButton.MouseLeftButtonDownEvent, new RoutedEventHandler(ButtonRoutedEventHandler), true);
            RadioButtonRect2.AddHandler(RadioButton.MouseLeftButtonDownEvent, new RoutedEventHandler(ButtonRoutedEventHandler), true);
            RadioButtonCircle.AddHandler(RadioButton.MouseLeftButtonDownEvent, new RoutedEventHandler(ButtonRoutedEventHandler), true);
            RadioButtonEllipse.AddHandler(RadioButton.MouseLeftButtonDownEvent, new RoutedEventHandler(ButtonRoutedEventHandler), true);
        }
