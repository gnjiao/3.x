...
namespace Hdc.Mv
{
    public static class RelativeCoordinateEx
    {
        ...
        public static void ChangeOriginOffsetUsingRelative(this IRelativeCoordinate coordinate, double xInPixel, double yInPixel)
        {
//            var relativeVector = coordinate.GetRelativeVector(new Vector(xInPixel, yInPixel));
//            coordinate.ChangeOriginOffsetUsingRelative(relativeVector);
            coordinate.ChangeOriginOffsetUsingRelative(new Vector(xInPixel, yInPixel));
        }
    }
}