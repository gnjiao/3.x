...
namespace Core.Collections
{
	...
	public class AsyncObservableCollectionReadOnlyCopy<T> : ICollection, ICollection<T>, IReadOnlyList<T> // where T : class
	{
		// ******************************************************************
		...
		// ******************************************************************
		public AsyncObservableCollectionReadOnlyCopy()
		{
		...
		{
		    AsyncObservableCollectionReadOnlyCopy<string> colTest = new AsyncObservableCollectionReadOnlyCopy<string>();
			colTest.Add("2");
