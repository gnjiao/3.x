...
namespace Hdc.Mv.Inspection
{
    public static class HDevelopExportExtensions
    {
        ...
        public static HRegion FindHoleHalfCircleRegion(this HImage ho_Image,
            bool LeftOrRight, bool HasPre, int HoughCircleThresholdGrayMin, int HoughCircleThresholdGrayMax,
            int HoughCircleSelectAreaMin, int HoughCircleSelectAreaMax, int HoughCircleRadius,
            int HoughCirclePercent, double MaxLineWidth)
        {
            HObject foundRegionObject;

            HDevelopExport.Singletone.FindHoleHalfCircleRegion(ho_Image, out foundRegionObject,
            LeftOrRight?"true":"false", HasPre ? "true" : "false", HoughCircleThresholdGrayMin, HoughCircleThresholdGrayMax,
            HoughCircleSelectAreaMin, HoughCircleSelectAreaMax, HoughCircleRadius,
            HoughCirclePercent, MaxLineWidth);
